...
export default function Nav() {
    ...
    return (
        <section className="z-[999] absolute top-0 left-0 py-2 lg:px-[50px] px-[25px] right-0 rounded-0 bg-white">
            ...
            <div className='flex items-center justify-between '>
                ...
                <div ref={menuRef} className={`${showMenu? 'flex openmenu':'hidden closemenu'} z-[999] lg:relative lg:top-0 absolute top-16 mt-5 lg:mt-0 lg:block flex-col items-center gap-5 bg-white lg:bg-inherit w-full lg:w-auto right-0 left-0 lg:p-0 p-5  transition-all duration-[2s] ease-in-out`}>
